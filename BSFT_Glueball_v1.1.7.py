...
# ======================================================================
# BSFT GLUEBALL v1.1.5-paper1 - HOLOGRAPHIC 3D PROJECTION
# Reproduces Fig1, Fig2 and Results.txt for PRL submission
# ======================================================================

print("="*70)
print("BSFT GLUEBALL v1.1.5-paper1 - HOLOGRAPHIC 3D PROJECTION")
print("="*70)
...
# ======================================================================
with open('BSFT_Results_Log_v1.1.5.txt', 'w', encoding='utf-8') as f:
    f.write("="*70 + "\n")
    f.write("BSFT SCALAR GLUEBALL - HOLOGRAPHIC 3D PROJECTION v1.1.5\n")
    ...
    f.write("  - BSFT_Results_Log_v1.1.5.txt (this file)\n\n")
...
print(f"✓ BSFT_Results_Log_v1.1.5.txt gerado")
print("\n" + "="*70)
